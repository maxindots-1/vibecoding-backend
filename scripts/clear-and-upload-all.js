...
const artistFolders = {
  'Alessandro Capozzi': 'Alessandro Capozzi',
  'Chen Jie': 'Chen Jie',
...
async function clearAndUploadAll() {
  console.log('🚀 Clearing storage and uploading all files...');
  
  // First, clear all files from storage
...
// Run the upload
clearAndUploadAll().catch(console.error);
