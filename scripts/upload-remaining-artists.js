...
// Artist folders mapping - only the ones that need uploading
const artistFolders = {
...
async function uploadRemainingArtists() {
  console.log('🚀 Uploading remaining artists...');
...
// Run the upload
uploadRemainingArtists().catch(console.error);
